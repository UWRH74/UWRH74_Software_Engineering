...
namespace excel_generalasa_kodbol
{
    public partial class Form1 : Form
    {
        ...
        void CreateTable()
        {
            ...
            for (int i = 1; i < sorokSzáma+1; i++)
            {
                adatRange[i, 1].Font.Bold = true;
                adatRange[i, 1].Interior.Color = Color.LightYellow;
            }
            int lastRowID = xlSheet.UsedRange.Rows.Count;
            for (int i = 1; i < oszlopokSzáma + 1; i++)
            {
                adatRange[i, lastRowID].Interior.Color = Color.LightGreen;
                //adatRange[i, lastRowID].NumberFormat = "#.00";
            }
